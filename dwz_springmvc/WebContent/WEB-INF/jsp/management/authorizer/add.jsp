...
<form method="post" action="<c:url value='/management/authorizer/insert?navTabId=authorizerLiNav&callbackType=closeCurrent'/>" class="pageForm required-validate" onsubmit="return validateCallback(this,navTabAjaxDone);">
	<div class="pageFormContent" layoutH="56">
		...
		<p>
			<label>摘要: </label>
			<input type="text" name="summary" maxlength="1000"/>
		</p>
		<p class="nowrap">
			<label>介绍: </label>
