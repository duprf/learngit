...
<body scroll="no">
	<div id="layout">
		...
		<div id="leftside">
			...
			<div id="sidebar">
				<div class="toggleCollapse"><h2>知识库管理</h2><div>collapse</div></div>
				...
				<div class="accordion" fillSpace="sideBar">
					...
					<div class="accordionContent">
						<ul class="tree treeFolder">
							<li><a href="<c:url value='/management/book'/>" target="navTab" rel="bookLiNav">图书管理</a></li>
						</ul>
					</div>
					...
					<div class="accordionContent">
						<ul class="tree treeFolder">
							...
							<!-- <li><a href="<c:url value='/management/role'/>" target="navTab" rel="roleLiNav">角色管理</a></li>
							<li><a href="<c:url value='/management/resource'/>" target="navTab" rel="resourceLiNav">权限资源管理</a></li> -->
							<li><a href="<c:url value='/management/company'/>" target="navTab" rel="companyLiNav">团体管理</a></li>
							<li><a href="<c:url value='/management/category'/>" target="navTab" rel="categoryLiNav">学科专业分类</a></li>
							<li><a href="<c:url value='/management/publishing'/>" target="navTab" rel="publishingLiNav">所属机构管理</a></li>
							<li><a href="<c:url value='/management/author'/>" target="navTab" rel="authorLiNav">著作人管理</a></li>
							<li><a href="<c:url value='/management/authorizer'/>" target="navTab" rel="authorizerLiNav">第三方授权人管理</a></li>
						</ul>
					</div>
					<div class="accordionHeader">
